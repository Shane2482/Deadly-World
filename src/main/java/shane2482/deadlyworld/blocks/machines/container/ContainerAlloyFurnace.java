...
public class ContainerAlloyFurnace extends Container {
	private final TileEntityAlloyFurnace Te;
	private int cookTime;
	private int power;

	public ContainerAlloyFurnace(InventoryPlayer playerInventory, TileEntityAlloyFurnace furnaceInventory,
			EntityPlayer player) {
		...
		// Input
		addSlotToContainer(new Slot(furnaceInventory, 0, 57, 10));
		addSlotToContainer(new Slot(furnaceInventory, 1, 57, 53));
		// Fuel
		addSlotToContainer(new Slot(furnaceInventory, 2, 14, 53));
		// Output
		addSlotToContainer(new SlotAlloyFurnace(playerInventory.player, furnaceInventory, 3, 134, 33));
