...
public class TileEntityPlywoodChest extends TileEntityLockableLoot implements ITickable, IInventory {
	...
	public String getName() {
		return hasCustomName() ? customName : "container.plywood_chest";
	}
	...
	public void closeInventory(EntityPlayer player) {
		if (!player.isSpectator() && getBlockType() instanceof block_plywood_chest) {
			--numPlayersUsing;
			worldObj.addBlockEvent(pos, getBlockType(), 1, numPlayersUsing);
	...
	public void update() {
		...
		if (++ticksSinceSync % 20 * 4 == 0) {
			worldObj.addBlockEvent(pos, ModBlocks.Plywood_Chest, 1, numPlayersUsing);
		}
