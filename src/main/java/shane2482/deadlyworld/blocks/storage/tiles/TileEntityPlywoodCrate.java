...
public class TileEntityPlywoodCrate extends TileEntityLockableLoot implements ITickable, IInventory {
	...
	public String getName() {
		return hasCustomName() ? customName : "container.plywood_crate";
	}
	...
	public void closeInventory(EntityPlayer player) {
		if (!player.isSpectator() && getBlockType() instanceof block_plywood_crate) {
			--numPlayersUsing;
			worldObj.addBlockEvent(pos, getBlockType(), 1, numPlayersUsing);
	...
	public void update() {
		...
		if (++ticksSinceSync % 20 * 4 == 0) {
			worldObj.addBlockEvent(pos, ModBlocks.Plywood_Crate, 1, numPlayersUsing);
		}
