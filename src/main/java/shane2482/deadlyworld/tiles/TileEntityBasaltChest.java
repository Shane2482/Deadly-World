...
public class TileEntityBasaltChest extends TileEntityLockableLoot implements ITickable, IInventory {
   ...
   public void updateContainingBlockInfo()
    ...
    public void update()
    {
         ...
         {
             this.worldObj.addBlockEvent(this.pos, ModBlocks.Basalt_Chest, 1, this.numPlayersUsing);
         }
    ...
    {
        if (!player.isSpectator() && this.getBlockType() instanceof block_basalt_chest)
        {
            --this.numPlayersUsing;
            this.worldObj.addBlockEvent(this.pos, this.getBlockType(), 1, this.numPlayersUsing);
            //this.worldObj.notifyNeighborsOfStateChange(this.pos, this.getBlockType());
